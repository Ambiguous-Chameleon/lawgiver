...
scoreboard players set @s RCCooldown 1
...
playsound ac_tech:item.lawgiver.shoot master @a ~ ~ ~ 0.7 1.5

data merge storage minecraft:game_ref {Data:{raycast:{dist:25,type_set:["#ac_lib:mobs"],function1:"code:item/lawgiver/mode/full_auto/hit",executor:"target"}}}
